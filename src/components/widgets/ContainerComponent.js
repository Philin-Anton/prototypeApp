...
require('styles/widgets/Container.scss');
...
ContainerComponent.displayName = 'WidgetsContainerComponent';

// Uncomment properties you need
// ContainerComponent.propTypes = {};
// ContainerComponent.defaultProps = {};

export default DragDropContext(HTML5Backend)(ContainerComponent);
